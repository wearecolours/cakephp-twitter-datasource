 ...
 */
	public function create(Model $model, $fields = null, $values = null) {
		...
		case 'Account':
			throw new Exception('Account entries do not support create');
			break;
		case 'Tweet':
 ...
 */
	public function read(Model $model, $queryData = array(), $recursive = null) {
		...
		switch (get_class($model)) {
			case 'Account': // https://dev.twitter.com/docs/api/1.1/get/account/settings
				...
				// Autheticate !!! At this point the user has to be autenticated not the app !!
				// robably pass the accesss tokens generated by users in the login proccess !
				$this->_auth();
 ...
 */
	public function update(Model $model, $fields = null, $values = null, $conditions = null) {
		switch (get_class($model)) {
		case 'Account':
			throw new Exception('Account entries do not support update');
			break;
		case 'Tweet':
 ...
 */
	public function delete(Model $model, $id = null) {
		switch (get_class($model)) {
		case 'Account':
			throw new Exception('Account entries do not support delete');
			break;
		case 'Tweet':
